...
if(isset($_POST['login'])){
    ...
    $sel="SELECT * FROM customer WHERE email='$e' AND pass='$p'";
    $result=mysqli_query($con,$sel);
    if($result->num_rows>0){
        $rs=$result->fetch_assoc();

        $_SESSION['cs_id']=$rs['id'];
        $_SESSION['cs_name']=$rs['name'];
              ...
              <div class="card-body">
                ...
                <form role="form" action="" method="post" class="text-start">
                    ...
                    <p class="mt-4 text-sm text-center">
                        ...
                        <a href="user_register.php" class="text-primary text-gradient font-weight-bold">Sign up</a>
                    </p>
                </form>
              </div>
            </div>
