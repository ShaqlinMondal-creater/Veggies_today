    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            if ($pro_qty > 0) {
                    ...
                    $ins = "INSERT INTO check_cart_data SET pro_qty='$pro_qty',user_id='$user_id',user_name='$user_name',pro_price='$pro_price',pro_name='$pro_name',pro_id='$pro_id',cart_id='$cart_id',date_time='$date_time'";
