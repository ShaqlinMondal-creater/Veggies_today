...
if(isset($_POST['login'])){
    ...
    $sel="SELECT * FROM seller WHERE s_email='$e' AND s_pass='$p'";
    $result=mysqli_query($con,$sel);
    if($result->num_rows>0){
        $rs=$result->fetch_assoc();

        $_SESSION['sl_id']=$rs['s_id'];
        $_SESSION['sl_name']=$rs['s_name'];
              ...
              <div class="card-body">
                ...
                <form role="form" action="" method="post" class="text-start">
                    ...
                    <p class="mt-4 text-sm text-center">
                        ...
                        <a href="seller_register.php" class="text-primary text-gradient font-weight-bold">Sign up</a>
                    </p>
                </form>
              </div>
            </div>
