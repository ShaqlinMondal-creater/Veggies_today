          ...
          <div class="row">
            ...
            <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column ms-auto me-auto ms-lg-auto me-lg-5">
              <div class="card card-plain">
                ...
                <div class="card-body">
                  <form role="form" action="insert_seller.php" method="post" enctype="multipart/form-data">
                    ...
                    <input type="submit" name="signup" value="SignUp" class="btn btn-lg bg-gradient-primary btn-lg w-100 mt-4 mb-0">
                ...
                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                  <p class="mb-2 text-sm mx-auto">
                    ...
                    <a href="seller_login.php" class="text-primary text-gradient font-weight-bold">Sign in</a>
                  </p>
                </div>
              </div>
            </div>
