    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" data-scroll="true">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder mb-0">Update Offer</h6>
        </nav>
        ...
        <div class="col-md-7 mt-4">
          <div class="card">
            <div class="card-header pb-0 px-3">
              <h6 class="mb-0">Update Product Offer</h6>
            </div>
              ...
              <ul class="list-group">
                ...
                <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
                  <div class="d-flex flex-column">
                    <form action="update_offer_ins.php" method="post">
                        <div class="div">
                        <input type="text" name="oid" value="<?php echo $rs['offer_id'];?>" style="width: 18vw;" hidden>
                        <h6 class="mb-3 text-sm">Offer Name : 
                            <input type="text" name="oname" value="<?php echo $rs['offer_name'];?>" style="width: 18vw;">
                        </h6>
                        <h6 class="mb-3 text-sm">Percentage : 
                            <input type="text" name="opercentage" value="<?php echo $rs['percentage'];?>" style="width: 18vw;" >
                        </h6>                      
                        <h6 class="mb-3 text-sm">Category : 
                                <select name="ocategory" id="">
                                    <option value="">Select</option>
                                        ...
                                        <optgroup label="<?php echo $rows['category_name'] ?>">
                                            ...
                                            ?>
                                            <option <?php if( $rs['category_name']==$rowsc ['category_id']){echo "selected";} ?> value="<?php echo $rowsc ['category_id']; ?>" ><?php echo $rowsc['category_name'];?></option>
                                            <?php } ?>
                                        </optgroup>
                                        <?php  } ?>
                                </select>
