    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" data-scroll="true">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder mb-0">Add Offer</h6>
        </nav>
        ...
        <div class="col-md-7 mt-4">
          <div class="card">
            <div class="card-header pb-0 px-3">
              <h6 class="mb-0">Product Offer Information</h6>
            </div>
            <div class="card-body pt-4 p-3">
              <ul class="list-group">
                <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
                  <div class="d-flex flex-column">
                    <form action="add_ins_offer.php" method="post">
                        <div class="div">
                        <h6 class="mb-3 text-sm">Offer Name : 
                            <input type="text" name="pname" style="width: 18vw;">
                        </h6>
                        <h6 class="mb-3 text-sm">Percentage : 
                            <input type="text" name="pprice" style="width: 18vw;" >
                        </h6>                      
