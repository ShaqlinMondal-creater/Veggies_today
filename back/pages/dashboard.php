        ...
        <!-- productshow -->
          <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
            <div class="card">
              ...
              <div class="card-footer p-3 bg-gradient-info shadow-primary" style="display:flex; justify-content:space-between;">
                <p class="mb-0" style="color:white;"><span class="text-dark text-sm font-weight-bolder">+ <?php echo $data;?></span> Products</p>
        ...
        <!-- Customer Table -->
          <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
            <div class="card">
              ...
              <hr class="dark horizontal my-0">
              <div class="card-footer p-3 bg-gradient-info shadow-primary" style="display:flex; justify-content:space-between;">
                <p class="mb-0" style="color:white;"><span class="text-dark text-sm font-weight-bolder">+ <?php echo $data;?></span> User</p>
        ...
        <!-- Seller Table -->
          <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
            <div class="card">
              ...
              <hr class="dark horizontal my-0">
              <div class="card-footer p-3 bg-gradient-info shadow-primary" style="display:flex; justify-content:space-between;">
                <p class="mb-0" style="color:white;"><span class="text-dark text-sm font-weight-bolder">+ <?php echo $data;?></span> Sellers</p>
            ...
            <div class="card">
              ...
              <div class="card-footer p-3 bg-gradient-info shadow-primary" style="display:flex; justify-content:space-between;">
                ...
                <span class="text-dark text-sm font-weight-bolder">+
                    <?php
                        // $name=$_SESSION['cs_name'];
                        $sql = "SELECT COUNT(*) AS total_rows FROM order_data";
                        $result = $con->query($sql);
